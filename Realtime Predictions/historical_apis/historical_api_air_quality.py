...
class HistoricalApiAirQuality:
    ...
    def air_quality_historical(self, start_datetime, end_datetime):
        ...
        #nombre del archivo del guardado de datos
        ...
        # obtener la información de las API
        ...
        # decodificar la información del JSON a un diccionario
        ...
        #se guarda el valor en orden de fecha y hora
        air_quality_df = air_quality_df.sort_values("datetime")

        #se guarda el dato como csv para la hora correspondiente
